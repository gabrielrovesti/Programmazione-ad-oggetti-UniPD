...
public class Ennagono extends PoligonoConvesso {
	protected double lati[]={0,0,0,0,0,0,0,0,0};
	protected int nLati=9;
	...
	public Ennagono(Vector<Vertice> V,boolean b) {
		super(V,9,"Ennagono",b);
		this.set_lati(V);
	}

	public Ennagono(Vector<Vertice> V) {
		super(V,9,"Ennagono");
	}
	...
	@Override
	public Ennagono clone() {
		return new Ennagono(this);
	}
