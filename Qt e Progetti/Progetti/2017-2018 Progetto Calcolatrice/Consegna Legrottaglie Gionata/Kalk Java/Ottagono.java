...
public class Ottagono extends PoligonoConvesso {
	protected double lati[]={0,0,0,0,0,0,0,0};
	protected int nLati=8;
	...
	public Ottagono(Vector<Vertice> V,boolean b) {
		super(V,8,"Ottagono",b);
		this.set_lati(V);
	}

	public Ottagono(Vector<Vertice> V) {
		super(V,8,"Ottagono");
	}
	...
	@Override
	public Ottagono clone() {
		return new Ottagono(this);
	}
